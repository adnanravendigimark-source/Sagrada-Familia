    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={onClose}>
      ...
      >
        <div className="flex items-center justify-between">
          ...
          {isEditing && (
            <span className="rounded-full bg-basilica-teal/10 px-2.5 py-0.5 text-xs font-semibold text-basilica-teal">
              Editing Image
            </span>
          )}
        </div>
        ...
        <div className="mt-3">
          ...
          <input
            ...
            placeholder="Describe what is shown in the image (e.g. Sagrada Familia Nativity Facade towers)"
            className="w-full rounded-lg border border-stone-300 px-3 py-2 text-sm focus:border-basilica-teal focus:outline-none focus:ring-1 focus:ring-basilica-teal"
          />
        </div>
        ...
        <div className="mt-5 flex items-center justify-between gap-2">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="rounded-lg bg-basilica-teal px-4 py-2 text-sm font-semibold text-white transition hover:bg-basilica-teal/90 disabled:opacity-60"
            >
