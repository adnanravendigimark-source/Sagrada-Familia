...
interface Props {
  ...
  /** Validation error message — shown below if non-empty */
  error?: string;
  className?: string;
}

const inputClass =
  "w-full rounded-lg border border-stone-300 px-3 py-2 pr-10 text-sm focus:border-basilica-teal focus:outline-none focus:ring-1 focus:ring-basilica-teal";
