        ...
        {TABS.map((tab) => (
          <button
            ...
            className={`flex items-center gap-1.5 rounded-xl px-3.5 py-2 text-sm font-medium transition ${
              activeTab === tab.key ? "bg-basilica-teal text-white shadow-sm" : "text-stone-600 hover:bg-stone-100"
            }`}
          >
      ...
      {activeTab === "content" && (
        <div className="space-y-5">
          <SectionCard title="Basics" description="What readers see as the title, and where the page lives.">
            <Field label="Title (H1 on the page)">
              <input
                ...
                placeholder="e.g. Best Time to Visit Sagrada Familia"
              />
            </Field>
              ...
              {post.content.map((block, i) => (
                <div
                  ...
                  className={`rounded-xl border bg-stone-50 p-4 transition-shadow ${
                    highlightIndex === i
                      ? "border-basilica-teal ring-2 ring-basilica-teal/40"
                      : "border-stone-200"
                  }`}
                >
          ...
          <SectionCard title='"Ready to book?" callout' description="The closing box at the end of the article — falls back to the default copy below until you change it.">
            ...
            <div className="rounded-2xl border border-basilica-teal/20 bg-basilica-teal/5 p-6">
              ...
              <span className="mt-4 inline-flex rounded-full bg-basilica-terracotta px-5 py-2.5 text-sm font-semibold text-white">
