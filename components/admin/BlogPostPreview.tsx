    ...
    <div className="overflow-hidden rounded-2xl border border-stone-200 bg-white shadow-sm">
      ...
      <div className="max-h-[calc(100vh-11rem)] overflow-y-auto">
        <div className="px-6 pt-6">
          <div className="flex items-center gap-3 text-xs font-semibold uppercase tracking-wide text-basilica-teal">
        ...
        <div className="px-6 pb-8 pt-6">
          ...
          <div className="mt-8 rounded-2xl border border-basilica-teal/20 bg-basilica-teal/5 p-5">
            ...
            <span className="mt-3 inline-flex rounded-full bg-basilica-terracotta px-4 py-2 text-sm font-semibold text-white">
