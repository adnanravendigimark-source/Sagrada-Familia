        ...
        <div className="sm:col-span-1">
          <div className="mb-1 flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs font-medium text-basilica-teal hover:underline"
            >
              Generate
            </button>
          </div>
            ...
            {PAGE_KEYS.map((key) => (
              <label key={key} className="flex items-center gap-1.5 text-sm text-stone-700">
                <input
                  ...
                  className="h-[18px] w-[18px] rounded border-stone-300 text-basilica-terracotta focus:ring-basilica-teal"
                />
                {PAGE_LABELS[key]}
              </label>
            ))}
