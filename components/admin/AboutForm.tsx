...
export default function AboutForm({ initial }: { initial: AboutPageContent }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <SectionCard title="Page Content" description="The whole page body, written as one article — headings, paragraphs, and lists.">
        <TiptapArticleEditor
          value={about.content}
          onChange={(html) => update("content", html)}
          placeholder="Write the About page here… use the toolbar for headings, bold, links, and lists."
          allowedHeadings={[2, 3]}
          minHeight="30rem"
        />
      </SectionCard>
