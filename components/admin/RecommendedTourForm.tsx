...
// Edits the same underlying homepage.json record as the Homepage page, but
// only exposes the "recommended tour" fields — the rest of the content
// (hero copy, etc.) is carried through untouched on save.
