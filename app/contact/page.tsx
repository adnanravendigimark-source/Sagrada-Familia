...
const reasons = [
  {
    icon: HeadsetIcon,
    title: "Booking Help",
    body: "Not sure whether to book the guided tour, tower access, or the skip-the-line ticket? Ask before you book.",
  },
  {
    icon: BriefcaseIcon,
    title: "Partnerships & Affiliates",
    body: "Tour operators, DMCs, and affiliate partners — reach out about listing or collaboration opportunities.",
  },
  {
    icon: MailIcon,
    title: "General Questions",
    body: "Site feedback, content corrections, or anything else about Sagrada Familia guided tours.",
  },
];
      ...
      <main className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-20">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-md text-stone-900/60">
            Questions about a Sagrada Familia guided tour or ticket — or a partnership inquiry?
        ...
        <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl border border-stone-900/10 bg-white p-8 text-center shadow-sm">
          <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-basilica-teal/10 text-basilica-teal">
          ...
          <div>
            ...
            <a
              href={`mailto:${EMAIL}`}
              className="mt-1 block break-all font-display text-lg font-semibold text-basilica-terracotta"
            >
              {EMAIL}
            </a>
          </div>
        ...
        <p className="mt-12 border-t border-stone-900/10 pt-8 text-center text-sm text-stone-900/60">
          Already have a booking? Contact the tour operator directly via your confirmation email —
          they handle changes and refunds faster than we can.
        </p>

        <div className="mt-10 flex flex-col items-center gap-4 rounded-2xl bg-basilica-teal/5 p-8 text-center">
