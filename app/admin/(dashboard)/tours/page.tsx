    ...
    <div>
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-stone-600">The bookable products shown on the homepage.</p>
        </div>
        <Link
          href="/admin/tours/new"
          className="rounded-lg bg-basilica-terracotta px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-basilica-terracotta/90"
        >
          + Add Tour
        </Link>
      </div>
        ...
        {tours.map((tour) => (
          ...
          >
            ...
            <Link
              ...
              className="shrink-0 text-sm font-medium text-basilica-teal hover:underline"
            >
              Edit
            </Link>
            {isAdmin && (
