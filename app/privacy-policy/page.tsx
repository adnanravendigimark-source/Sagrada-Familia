...
const TITLE = "Privacy Policy | Sagrada Familia Guided Tours";
const DESCRIPTION =
  "How this independent Sagrada Familia guided tour and ticket guide handles your information, affiliate links, and cookies.";
