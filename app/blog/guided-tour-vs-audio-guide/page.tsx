...
export default async function Post() {
  ...
  const articleJsonLd = buildArticleJsonLd({
    ...
    authorName: "Sagrada Familia Guided Tours",
    ...
    <>
      ...
      <main>
        <div className="mx-auto max-w-4xl px-4 pt-6 sm:px-6">
          <Link href="/blog" className="text-sm font-medium text-basilica-teal">{s.backToGuidesText}</Link>
          ...
          <div>
            ...
            <div className="mt-10 rounded-2xl border border-basilica-teal/20 bg-basilica-teal/5 p-6">
              ...
              <p className="mt-1 text-sm text-stone-900/70">
                Compare guided tour prices against the audio-guide and standard ticket options.
              </p>
              <Link
                href="/#prices"
