...
export interface Post {
  ...
  // same until someone actually edits it.
  ctaHeading: string;
  ctaBody: string;
...
function rowToPost(row: any): Post {
  return {
    ...
    ctaHeading: row.cta_heading || "Ready to book?",
    ctaBody: row.cta_body || "Compare guided tour prices and tickets on the homepage.",
    ctaButtonText: row.cta_button_text || "See Price Comparison",
    ctaButtonHref: row.cta_button_href || "/#prices",
